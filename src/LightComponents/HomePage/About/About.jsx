...
const About = () => {
  return (
    <div className="h-screen flex flex-col gap-4 items-center justify-center text-slate-500">
      ...
      <p className="w-[80%] text-sm sm:text-lg  text-slate-800">
        {info.about1}
        <span className="bg-gray-400 px-2  rounded-md">{info.aboutLanguages[0]}</span>,
        <span className="bg-gray-400 px-2 ml-1 rounded-md">{info.aboutLanguages[1]}</span>,
        <span className="bg-gray-400 px-2 ml-1 rounded-md">{info.aboutLanguages[2]}</span>,
        <span className="bg-gray-400 px-2 ml-1 rounded-md">{info.aboutLanguages[3]}</span>,
        and <span className="bg-gray-400 px-2 rounded-md">{info.aboutLanguages[4]}</span> {info.about2}
      </p>
