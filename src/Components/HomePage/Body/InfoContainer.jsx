  ...
  return (
    <div className=" space-y-1 lg:text-start text-center w-full md:w-[400px]">
      ...
      <div className="flex flex-wrap gap-x-2 gap-y-3 pt-1 lg:justify-normal justify-around">
        ...
        <Button name={"C/C++"} delay={0.6} />
        <Button name={"Framer Motion"} delay={0.7} />
        <Button name={"Tailwind CSS"} delay={0.8} />
        <Button name={"HTML5"} delay={0.9} />
        <Button name={"CSS"} delay={1.0} />
        <Button name={"JavaScript"} delay={1.1} />
      </div>
